...
On Laptop, the global Codex instruction file is:
...
- which Laptop machine files to read
...
~/Obsidian-Vault/AI Brain/Machines/Laptop/Current Context.md
~/Obsidian-Vault/AI Brain/Machines/Laptop/Local Setup.md
~/Obsidian-Vault/AI Brain/Machines/Laptop/Working Projects.md
```
...
```sh
cd ~/Obsidian-Vault
node "AI Brain/scripts/brain.mjs" closeout "Project Name" "Short session title" "Laptop" --summary "What changed" --next "Next action"
```
